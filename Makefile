...
LINUX_COMMON_RUNTIME_SRC := $(COMMON_RUNTIME_SRC) $(LINUX_COMMON_RUNTIME_H) $(LINUX_COMMON_RUNTIME_C)
...
FREEBSD_COMMON_RUNTIME_SRC := $(COMMON_RUNTIME_SRC) $(FREEBSD_COMMON_RUNTIME_H) $(FREEBSD_COMMON_RUNTIME_C)
...
MACH_COMMON_RUNTIME_SRC := $(COMMON_RUNTIME_SRC) $(MACH_COMMON_RUNTIME_H) $(MACH_COMMON_RUNTIME_C)
...
LINUX_COMMON_RUNTIME := $(COMMON_RUNTIME) $(foreach header,$(LINUX_COMMON_RUNTIME_H),--header $(header)) $(LINUX_COMMON_RUNTIME_C)
...
FREEBSD_COMMON_RUNTIME := $(COMMON_RUNTIME) $(foreach header,$(FREEBSD_COMMON_RUNTIME_H),--header $(header)) $(FREEBSD_COMMON_RUNTIME_C)
...
MACH_COMMON_RUNTIME := $(COMMON_RUNTIME) $(foreach header,$(MACH_COMMON_RUNTIME_H),--header $(header)) $(MACH_COMMON_RUNTIME_C)
